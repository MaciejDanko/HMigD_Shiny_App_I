...
ui_compare_models_single<-function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#eee0b9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f; height:132px',   #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:584px; margin-left:20px",
          ...
          br(),
          h3('Default model #1'),
          tags$head(tags$style("#MODEL1 .selectize-input items full has-options has-items {height:55px}")),
          selectInput("MODEL1", label = NULL,
                      choices = makeList(MODELS),
                      selected = 6, width='565px'),
          #br(),
      ),
      #div(class="col-lg-4", style='padding-right:0px; max-width:480px; min-width:10px; background-color:#fff0d0',
      #div(class="col", style='padding-right:0px; width:480px; min-width:10px; background-color:#fff0d0',
      div(style="display:inline-block;vertical-align:top; width:584px;  margin-left:20px",
          br(),
          h3('Alternative model #2'),
          tags$head(tags$style("#MODEL2 .selectize-input items full has-options has-items {height:55px}")),
          selectInput("MODEL2", label = NULL,
                      choices = makeList(MODELS),
  ...
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      #br(),
      #div(class="col-lg-4", style='padding-right:0px; max-width:960px; min-width:10px; background-color:#d0f0ff',
      div(style="display:inline-block;vertical-align:top; width:310px; margin-left:20px",
      ...
      div(style="display:inline-block;vertical-align:top; width:180px; margin-left:10px",
          
          br(),    
          h3(HTML('&#160;')),
          tags$head(
            #tags$style(HTML('#Reverse {background-color:#F0B0B0}')),
          ...
          #tags$style('#Reverse .btn-default{background-color: "#00B2EEFF"}', media="screen", type="text/css"),
          #tags$head(tags$style('.btn-default{background-color: "#00B2EEFF"}', media="screen", type="text/css")),
          #br(),
      ),
      #div(class="col-lg-4", style='padding-right:0px; max-width:960px; min-width:10px; background-color:#d0f0ff',
      div(style="display:inline-block;vertical-align:top; width:310px;  margin-left:0px",
          br(),     
      ...
      div(style="display:inline-block;vertical-align:top; width:320px;  margin-left:20px",
          br(),
          h3(HTML('Options')),
          #tags$head(tags$style(HTML('#UseAltPred1 :after, #UseAltPred1 :before{background-color:#bff442;}'))),
          myPrettyCheckbox("UseAltPred1", h4('Use alternative model predicting method'), value = FALSE, width = '300px'),
      ),
      # div(class='raw',style="width:620px; margin-left:240px",
      #     actionButton("Reverse", "Swap countries", width='300px'),
      #     
      #     ),
      br()
  ),
  ...
  div(class="row", style='margin-left:0px; margin-top:5px; margin-bottom:0px; background-color:#e8e9d9;width=1260px;border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  
      ...
      div(style="display:inline-block;vertical-align:top; width:525px; margin-left:20px",
          ...
          div(style="display:inline-block;vertical-align:top; width:525px; margin-left:0px",
              ...
              # conditionalPanel(condition = "input.UseThreshold == TRUE",
              #                  h3('Threshold year'),               
              #                  sliderInput(inputId = "ThrY", label = NULL, min = 2001, max = 2019, value = 2011, step=1, sep='',width = '525px')
              # ),
          ),
      ),
  ),
