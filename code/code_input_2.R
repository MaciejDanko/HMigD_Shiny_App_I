...
SaveBlock0 <- function (IDName, topmargin = -5, bg = '#F5DFD5'){
  ...
  div(class="row", style=paste0('margin-left:0px; margin-top:',topmargin,'px; ; background-color:',bg,'; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f'),   #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:220px;  margin-left:0px",
          br(),
          h3(save_plot_leg_txt),
          downloadButton(paste0("Save",IDName,"Plot"), save_plot_button_txt),
  ...
  tagList(
    div(class="row", style=paste0('margin-left:0px; margin-top:',topmargin,'px; ; background-color:',bg,'; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f'),   #style='margin:0px; padding:0px',
        ...
        div(style="display:inline-block;vertical-align:top; width:550px;  margin-left:20px",
            br(),
            h3('Data source:'),
            h4('Click on the link to view the source web page'),
            tags$ul(
              tags$li(
        ...
        #     br(),
        #     
        #     h3(download_button_leg_txt),
        #     
        #     downloadButton(paste0("Save",IDName,"DataRaw"),download_button_txt), #ui_password_btn(paste0("Save",IDName,"DataRaw")),
        #     
        #     
        # ),
  ...
  if (direction == "I"){
    ...
    div(class="row", style=paste0('margin-left:0px; margin-top:',topmargin,'px; ; background-color:',bg,'; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f'),   #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:550px;  margin-left:20px",
          ...
          h4('Click on the links to view the source web pages'),
          tags$ul(
            tags$li(
            ...
            tags$li(
              tags$a(href = "https://www.quantmig.eu/data_and_estimates/estimates_explorer/", "QuantMig"),
              " - QuantMig estimates for bilateral flows between GR, HU, MT, and PT. Accessed Nov 2023."
            ),
            tags$li(
              tags$a(href = "https://www-genesis.destatis.de/genesis/online?sequenz=statistikTabellen&selectionname=12711&language=en#abreadcrumb", "DE:DESTATIS"),
              " - DESTATIS, Statistisches Bundesamt, GENESIS Nov 2023."
            ),
            tags$li(
              tags$a(href = "https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/internationalmigration/datasets/ipscountryofbirthbycountryoflastornextresidence", "UK:NSO"),
            ...
            tags$li(
              ...
              " - Data used in IMEM and MIMOSA projects (Mainly Cyprus 2008 data; not avaialbale online)."
            )
          ),
      ),
      ...
      div(style="display:inline-block;vertical-align:top; width:250px;  margin-left:350px",
          ...
          downloadButton(paste0("Save",IDName,"DataSrc"), download_button_txt, style='width:200px'),
    ...
    div(class="row", style=paste0('margin-left:0px; margin-top:',topmargin,'px; ; background-color:',bg,'; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f'),   #style='margin:0px; padding:0px',
        ...
        div(style="display:inline-block;vertical-align:top; width:250px;  margin-left:350px",
          ...
          #  ui_password_btn(paste0("Save",IDName,"DataRaw")),
            ...
            # actionButton(paste0("Save",IDName,"DataRaw"), download_button_txt),
            # tags$head(tags$style(paste0("#Save",IDName,"DataRaw {width:200px}"), media="screen", type="text/css")),
...
SaveBlock1 <- function (IDName, topmargin = -5, bg = '#F5DFD5'){
  ...
  div(class="row", style=paste0('margin-left:0px; margin-top:',topmargin,'px; ; background-color:',bg,'; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f'),   #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:350px;  margin-left:100px",
          br(),
          h3(download_button_leg_txt),
          downloadButton(paste0("Save",IDName,"Data"), download_button_txt),
          tags$head(tags$style(paste0("#Save",IDName,"Data {width:200px}"), media="screen", type="text/css")),
      ),
...
ModelsOutputFrame <- function(DTid="MixedModelTable",BTNid='SelectedModelTableDownload',
                              #headtxt='Estimated migratioon flows for selected models', 
                              headtxt='Download entire database including data and metadata',
                              topmargin = 5, bg = '#F5DFD5'){
  # tagList(
  ...
  # 
  div(class="row", style=paste0('margin-left:0px; margin-top:',topmargin,'px; ; background-color:',bg,'; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f'),   #style='margin:0px; padding:0px',
      div(style="display:inline-block;vertical-align:top; width:960px;  margin-left:20px",
          br(),
          #h3(headtxt),
          div(
            style = 'font-size: 1.55em;',headtxt
          )
      ),
      # div(style="display:inline-block;vertical-align:top; width:220px;  margin-left:0px",
      #    br()
      ...
      div(style="display:inline-block;vertical-align:top; width:220px;  margin-left:0px",
          ...
          downloadButton(BTNid, "Download HMigD"),
          tags$head(tags$style(paste0('#',BTNid," {width:200px}"), media="screen", type="text/css")),
      ),
      br(),br(),
  )
}
