...
Data_input_80a<<-get_data('./data/DataAndFit_80a.RDA')
Data_input_80b<<-get_data('./data/DataAndFit_80b.RDA')
Data_input_80c<<-get_data('./data/DataAndFit_80c.RDA')
Data_input_80d<<-get_data('./data/DataAndFit_80d.RDA')
Data_input_80e<<-get_data('./data/DataAndFit_80e.RDA')
Data_input_80f<<-get_data('./data/DataAndFit_80f.RDA')
