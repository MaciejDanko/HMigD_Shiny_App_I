...
ui_flow_sources_imm <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:850px;  margin-left:40px; margin-top:5px",
          ...
          customSliderInput(inputId = "src_i_year", label = NULL, 
...
ui_flow_sources_emi<-function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:850px;  margin-left:40px; margin-top:5px",
          ...
          customSliderInput(inputId = "src_e_year", label = NULL, 
                            min = min(Years), max = max(Years), value = Years[10], step=1, sep='',
...
ui_flow_coverage <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#FFFFFF; width:1215px; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',
      ...
      div(style="display:inline-block;vertical-align:top; width:150px; margin-left:20px; margin-top:0px",
          ...
          downloadButton("CoverageTableDownload", download_button_txt),
...
ui_transition_coverage <- function() tagList(
  ...
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#FFFFFF; width:1215px; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',
      ...
      div(style="display:inline-block;vertical-align:top; width:150px; margin-left:20px; margin-top:0px",
          ...
          downloadButton("CoverageTransitionsTableDownload", download_button_txt),
...
ui_transition_undercounting <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#FFFFFF; width:1215px; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',
      ...
      div(style="display:inline-block;vertical-align:top; width:150px; margin-left:20px; margin-top:0px",
          ...
          downloadButton("UndercountingTransitionsTableDownload", download_button_txt),
...
ui_transition_accuracy <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#FFFFFF; width:1215px; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',
      ...
      div(style="display:inline-block;vertical-align:top; width:150px; margin-left:20px; margin-top:0px",
          ...
          downloadButton("AccuracyTransitionsTableDownload", download_button_txt),
...
ui_covariates_freedom <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:1000px;  margin-left:40px; margin-top:5px",
          ...
          customSliderInput(inputId = "AcceuYear", label = NULL, 
                            min = min(Years), max = max(Years), value = Years[3], step=1, sep='',
                            width='1000px', 
          ),
          br(),
      ),
...
#           
#           customSliderInput(inputId = "trade_year", label = NULL, 
#                       min = min(Years), max = max(Years), value = Years[10], step=1, sep='',
#                       
...
#           # div(style="display:inline-block;vertical-align:top; width:500px;  margin-left:40px; margin-top:5px",
#           
#           customSliderInput(inputId = "gni_year", label = NULL, 
#                       min = min(Years), max = max(Years), value = Years[10], step=1, sep='',
#                       
#                       width='500px', round=TRUE,
#                       
  ...
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; margin-left:20px;width:1200px",
          ...
          div(style="display:inline-block;vertical-align:top; width:1080px;  margin-left:20px; margin-top:5px",
              ...
              customSliderInput(inputId = "visualize_output_year", label = NULL, 
                                min = min(Years), max = max(Years), value = Years[10], step=1, sep='',
                                width='1000px'
              ),
              br(),
...
ui_transitions_count <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:850px;  margin-left:40px; margin-top:5px",
          ...
          customSliderInput(inputId = "transitions_count_year",  label = NULL, 
                            min = min(Years), max = max(Years), value = Years[10], step=1, sep='',
                            width='850px', 
          ),
...
ui_flow_imm <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:1000px;  margin-left:40px; margin-top:5px",
          ...
          customSliderInput(inputId = "flows_imm_year", label = NULL, 
                            min = min(Years), max = max(Years), value = Years[10], step=1, sep='',
                            width='1000px', 
          ),
          br(),
...
ui_flow_emi <- function() tagList(
  div(class="row", style='margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  #style='margin:0px; padding:0px',
      ...
      div(style="display:inline-block;vertical-align:top; width:1000px;  margin-left:40px; margin-top:5px",
          ...
          customSliderInput(inputId = "flows_emi_year", label = NULL, 
                            min = min(Years), max = max(Years), value = Years[10], step=1, sep='',
                            width='1000px'),
          br(),
      ),
...
ui_compare_models_single<-function() tagList(
  ...
  div(class="row", style='display: inline-flex; margin-left:0px; margin-top:5px; background-color:#e8e9d9; border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f; width:1215',  #style='margin:0px; padding:0px',
      ...
      div(style=" vertical-align:top; width:380px;  margin-left:30px",
          ...
          div(style="margin-top:-20px; margin-bottom:5px; width:300px",
              uiOutput('UnlockIMEMSin'), #ui_password_btn('UnlockIMEMSin'),
  ...
  SaveBlock2b(IDName='Model1', topmargin = 5, 
              ...
              downbutton=download_button_txt#, 
  ...
  div(class="row", style='margin-left:0px; margin-top:5px; margin-bottom:0px; background-color:#e8e9d9;width=1260px;border-style: solid; border-color:#9985A2; border-width:1px; color:#2f4b2f',  
      ...
      div(style = "display: inline-flex; align-items: center; width: 1200px; margin-left: 20px; margin-bottom:-10px;",
          ...
          div(style = "width: 950px;",
              selectInput("Examples1", label = NULL, selectize=FALSE,
                          ...
                          selected = grep('7g',FREEDOMCASES)+1,width='920px'),
          ),
      ),
      hr(style="border-top: 0.5px solid"),
      div(style="display:inline-block;vertical-align:top; width:580px; margin-left:20px",
          #br(),
          h3("Sending countries"),
          myPrettyGroupCheckbox("SendCntrs", label =NULL,
                                choices = CountriesFull, selected = CountriesFull[Countries%in%c('CZ','PL','SK')], inline = TRUE, ncol = 4),
      ...
      div(style="display:inline-block;vertical-align:top; width:580px; margin-left:20px; margin-bottom:20px",
          ...
          myPrettyGroupCheckbox("RecCntrs", label=NULL,
                                choices = CountriesFull, selected = CountriesFull[Countries%in%c('DE')], inline = TRUE, active.bg = "#0861ae", ncol=4),
      ...
      div(style="display:inline-block;vertical-align:top; width:1215px; margin-left:20px",
          ...
          div(style="display:inline-block;vertical-align:top; width:525px; margin-left:0px",
              ...
              div(helper(myPrettyCheckbox("sdat", h4('Show aggregated data'), value = FALSE, width = '280px'),
                         colour='#FF0000',type='inline',title='Show aggregated data',buttonLabel = 'Close',
                         content=aDATAtxt), style="margin-bottom:-10px;width:280px"),
              div(myPrettyCheckbox("aCI", h4('Show credibility intervals'), value = TRUE, width = '525px'),
          ...
          div(style="display:inline-block;vertical-align:top; width:525px; margin-left:40px",
              br(),br(),    
              div(class = 'row', style = 'display: inline-block; align-items: left; margin-bottom:5px; margin-left:0px; width:525px',
                  ...
                  div(class = 'col', style = 'display: inline-block; text-align: left; width:300px;margin-top:-5px; margin-bottom:-10px',
                      uiOutput('UnlockIMEMAgr'),    #ui_password_btn('UnlockIMEMAgr'),    
                  ),
              ),
...
ui_output<-function() tagList(
  ...
  ModelsOutputFrame(headtxt='Download the entire database with user-selected models, including both data and metadata'),
)